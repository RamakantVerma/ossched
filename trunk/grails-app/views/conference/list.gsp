    ...
    <head>
        ...
        <g:javascript>
            function showCalendarPopup(){
                window.open("calendar.gsp","Calendar","status = 0, height = 620, width = 820");
            }
        </g:javascript>
    </head>
    <body>
        <div class="nav">
            ...
            <span class="menuButton"><a class="calendar" href="javascript:showCalendarPopup();">Show Calendar</a></span>
        </div>
        <div class="body">
