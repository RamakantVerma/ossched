<html>
    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form method="post" onsubmit="return validatePage()" >
                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="selectable">Time Slot:</label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean:conference,field:'startDateTime','errors')}">
                                    <table cellpadding="0" cellspacing="0" style="border:none;">
                                        ...
                                        <td style="padding:0px; text-align: center;">
                                            <ol id="selectable">
                                                ...
                                                <li class="ui-state-default">7:00 PM</li>
                                                <li class="ui-state-default" style="font-size: 7pt;">7:30 PM</li>
                                                <li class="ui-state-default">8:00 PM</li>
                                                <li class="ui-state-default" style="font-size: 7pt;">8:30 PM</li>
                                                <li class="ui-state-default">9:00 PM</li>
                                                <li class="ui-state-default" style="font-size: 7pt;">9:30 PM</li>
                                                <li class="ui-state-default">10:00 PM</li>
                                            </ol>
                                        </td>
                                        </tr>
                                        <tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:conference,field:'lengthOfConference','errors')}">
                                    ...
                                    <g:textField id="lengthOfConference" name="lengthOfConference" size="3" value="${conference.lengthOfConference}" readonly="readonly" />
                                    hour(s).
                                </td>
                            </tr> 
        ...
        <g:javascript>
            ...
            getExistingStartTime();
            getExistingEndTime();
            formatStartDate();
            var durationStr = document.getElementById("lengthOfConference").value.toString();
            var duration = new Array();
            duration = durationStr.split(".");
            selectExistingTimeslot(document.getElementById("startTimeValue").value, (parseInt(duration[0]) * 2) + (parseInt(duration[1]) * 0.2) );
        </g:javascript>
